...
const ResendVerificationPage: Component = () => {
        ...
        <div class="max-w-md w-full space-y-8">
          <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
            <div class="text-center">
              <h2 class="text-2xl font-bold text-gray-900">Renvoyer l'email de vérification</h2>
                  ...
                  <div class="flex">
                    ...
                    <div class="ml-3">
                      <p class="text-sm text-green-800">
                        Un email de vérification a été envoyé à {email()}. Vérifiez votre boîte de réception.
                      </p>
                    </div>
                  </div>
                </div>
